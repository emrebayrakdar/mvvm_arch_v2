...
class $UserMapper implements AutoMapprInterface {
  ...
  bool canConvert<SOURCE, TARGET>({bool recursive = true}) {
    ...
    if ((sourceTypeOf == _typeOf<UserEntity>() ||
        ...
        (targetTypeOf == _typeOf<UserUiModel>() ||
            targetTypeOf == _typeOf<UserUiModel?>())) {
      return true;
    }
    if (recursive) {
  ...
  TARGET? _convert<SOURCE, TARGET>(
    ...
    if ((sourceTypeOf == _typeOf<UserEntity>() ||
      ...
      return (_map__UserEntity__To__UserUiModel((model as UserEntity?))
          as TARGET);
    }
    throw Exception('No ${model.runtimeType} -> $targetTypeOf mapping.');
  }

  UserUiModel _map__UserEntity__To__UserUiModel(UserEntity? input) {
    final model = input;
    if (model == null) {
      throw Exception(
